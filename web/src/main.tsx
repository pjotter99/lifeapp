...
// und wird von /einstellungen aus verlinkt. /db-test ist keine echte
// Screen-Route, sondern die Verifikationsseite fuer Umbau-Punkt 1 (sql.js im
// Browser) — nicht in der Tab-Leiste verlinkt. currentRoute() statt direkt
